...
const DataTable = ({
  ...
  const reversedColumns =
    i18n && i18n.language === "ar" ? columns.reverse() : columns;
...
<div className="datatable max-w-[24rem] sm:max-w-[36rem] md:max-w-[48rem] lg:max-w-[60rem] xl:max-w-[72rem] overflow-x-auto"
        ...
        <div className="datatableTitle">
          ...
          <span className="leftDatatableTitle">
            {buttonVisibility !== false && (
              ...
              >
                {NewUser && (
                  <button onClick={togglePopup} className="link">
                    New User
                  </button>
                )}
            ...
            {AssignPickListBtn && (
              <button onClick={handleUserListPopUp}>Assign Picklist</button>
            )}
