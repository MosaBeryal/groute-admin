...
import Gs1Barcodes from "../../../UserPages/Gs1Barcodes/Gs1Barcodes";
import newRequest from "../../../../UserRequest";
import { toast } from "react-toastify";

const ViewTemplate4PopUp = ({ isVisible, setVisibility, slug }) => {
            ...
            >
              <div className="w-full">
                ...
                {isLoading ? (
                  ...
                  viewTemplateData && (
                    <Gs1Barcodes pageData={viewTemplateData} />
                  )
                )}
...
export default ViewTemplate4PopUp;
