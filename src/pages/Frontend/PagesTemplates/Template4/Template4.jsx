...
import AddTemplate4 from "./AddTemplate4";
import UpdateTemplate4 from "./UpdateTemplate4";
import ViewTemplate4PopUp from "./ViewTemplate4Popup";
...
const Template4 = () => {
  ...
  const {
    ...
    const refetchTemplate4Data = async () => {
      try {
    ...
    useEffect(() => {
      refetchTemplate4Data(); // Calling the function within useEffect, not inside itself
    }, []);
      ...
      >
        ...
        {isCreatePopupVisible && (
          <AddTemplate4
            ...
            refreshTemplate4Data={refetchTemplate4Data}
          />
        )}

        {isUpdatePopupVisible && (
          <UpdateTemplate4 isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshTemplate4Data={refetchTemplate4Data} />
        )}

        {isViewPopupVisible && (
          <ViewTemplate4PopUp isVisible={isViewPopupVisible} setVisibility={setViewPopupVisibility} slug={viewSlug}/>
        )}
      </div>
    </div>
  );
