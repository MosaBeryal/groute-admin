...
const UpdateTemplate6 = ({ isVisible, setVisibility, refreshTemplate6Data }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (section_image2) {
      ...
      formData.append("sections[1][contents][0][data][fileField]", "section_image");
    }
          ...
          <div className="popup-container h-auto sm:w-[90%] w-full">
            <div className="popup-form w-full" style={{ maxHeight: "90vh", overflowY: "auto" }}>
              <div className="w-full">
                ...
                <div className="relative w-full h-[450px]">
                  ...
                  <div className="absolute sm:top-1/6 top-2.5 text-white md:px-10 px-3">
                    <textarea
                      ...
                      value={state.sections[0].contents[0].data.heading}
                      onChange={(e) =>
                        handleChange(
                    ...
                    <textarea
                      ...
                      className="w-full h-14 bg-transparent sm:text-5xl text-3xl font-sans font-semibold mb-4 text-white"
                      value={state.sections[0].contents[0].data_ar.heading}
                      onChange={(e) =>
                        handleChange(
                ...
                <div className="h-auto w-full px-4 md:px-12 mt-20">
                  <div className="flex flex-wrap justify-center items-center gap-6 md:gap-0 md:mb-20 mb-8">
                    <div className="w-full md:w-1/2 flex flex-col md:gap-9 gap-3">
                      <div className="">
                        <textarea
                          className="w-full h-14 sm:text-4xl text-lg font-bold font-sans text-secondary"
                          placeholder="Product Connect"
                          value={state.sections[1].contents[0].data.heading}
                          onChange={(e) =>
                            handleChange(
                              "sections.1.contents.0.data.heading",
                              e.target.value
                            )
                          }
                        />
                        <textarea
                          className="w-full h-14 sm:text-4xl text-lg font-bold font-sans text-secondary"
                          placeholder="Product Connect [Arabic]"
                          value={state.sections[1].contents[0].data_ar.heading}
                          onChange={(e) =>
                            handleChange(
                              "sections.1.contents.0.data_ar.heading",
                              e.target.value
                            )
                          }
                        />
                        ...
                        <textarea
                          className="w-full text-base font-sans font-semibold text-primary mt-1"
                          placeholder="Photography Services"
                          value={state.sections[1].contents[0].data.title}
                          onChange={(e) =>
                            handleChange(
                              "sections.1.contents.0.data.title",
                              e.target.value
                            )
                          }
                        />
                        <textarea
                          className="w-full text-base font-sans font-semibold text-primary mt-1"
                          placeholder="Photography Services [Arabic]"
                          value={state.sections[1].contents[0].data_ar.title}
                          onChange={(e) =>
                            handleChange(
                              "sections.1.contents.0.data_ar.title",
                              e.target.value
                            )
                          }
                        />
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-center items-center">
                      {section_image2 ? (
                        ...
                        <img src={imageLiveUrl(state.sections[1].contents[0].data.section_image)} alt="Selected" />
                      )}
                      <input
                        type="file"
                        accept="image/*"
                ...
                <div className=" font-body sm:text-base text-sm flex flex-col gap-0">
                  <label
                    htmlFor="field6"
                  ...
                  <input
                    ...
                    placeholder={`${t("Enter")} ${t("Video URL")}`}
                  />
                </div>
...
export default UpdateTemplate6;
