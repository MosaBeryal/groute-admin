...
const AddTemplate6 = ({ isVisible, setVisibility, refreshTemplate6Data }) => {
  ...
  const handleFileChange = (e, fileField) => {
    ...
    } else if (fileField === "section_image") {
            ...
            >
              <div className="w-full">
                ...
                <div className="relative w-full h-[450px]">
                  ...
                  <div className="absolute top-3 text-white md:px-10 px-3">
                    <textarea
                    ...
                    <ReactQuill
                      ...
                      modules={modules}
                      formats={formats}
                      className="font-sans text-base text-gray-600 h-auto bg-white mt-3"
                      placeholder="Write description arabic here..."
                      onChange={(value) =>
                        handleChange(
