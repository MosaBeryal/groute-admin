...
const UpdateTemplate1 = ({ isVisible, setVisibility, refreshTemplate1Data }) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await newRequest.put(`/blogs?template_name=template1`, formData);
              ...
              <div className="w-full">
                ...
                <div className="py-3 shadow-lg px-3 mb-3">
                  ...
                  <div className="font-body sm:text-base text-sm flex flex-col gap-0 mt-4 mb-3">
                    ...
                    <select
                      id="fields4"
                      className={`border-[1px] rounded-sm border-[#8E9CAB] p-2 ${i18n.language === "ar" ? "text-end" : "text-start"}`}
                      value={state.status}
...
export default UpdateTemplate1;
