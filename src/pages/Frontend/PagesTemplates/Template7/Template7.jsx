...
import AddTemplate7 from "./AddTemplate7";
import ViewTemplate7PopUp from "./ViewTemplate7PopUp";
import UpdateTemplate7 from "./UpdateTemplate7";
...
const Template7 = () => {
  ...
  const {
    ...
    const refetchTemplate7Data = async () => {
      try {
    ...
    useEffect(() => {
      refetchTemplate7Data(); // Calling the function within useEffect, not inside itself
    }, []);
      ...
      >
        ...
        {isCreatePopupVisible && (
          <AddTemplate7
            ...
            refreshTemplate7Data={refetchTemplate7Data}
          />
        )}
