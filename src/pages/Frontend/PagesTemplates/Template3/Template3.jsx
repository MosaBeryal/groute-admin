...
import AddTemplate3 from "./AddTemplate3";
import UpdateTemplate3 from "./UpdateTemplate3";
import ViewTemplate3PopUp from "./ViewTemplate3PopUp";
...
const Template3 = () => {
  ...
  const {
    ...
    const refetchTemplate3Data = async () => {
      try {
    ...
    useEffect(() => {
      refetchTemplate3Data(); // Calling the function within useEffect, not inside itself
    }, []);
      ...
      >
        ...
        {isCreatePopupVisible && (
          <AddTemplate3
            ...
            refreshTemplate3Data={refetchTemplate3Data}
          />
        )}

        {isUpdatePopupVisible && (
          <UpdateTemplate3 isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshTemplate3Data={refetchTemplate3Data} />
        )}
        
        {isViewPopupVisible && (
          <ViewTemplate3PopUp isVisible={isViewPopupVisible} setVisibility={setViewPopupVisibility} slug={viewSlug}/>
        )}
      </div>
    </div>
  );
