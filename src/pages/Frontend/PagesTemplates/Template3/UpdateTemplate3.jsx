...
const UpdateTemplate3 = ({ isVisible, setVisibility, refreshTemplate3Data }) => {
          ...
          <div className="popup-container h-auto sm:w-[90%] w-full">
            <div className="popup-form w-full" style={{ maxHeight: "90vh", overflowY: "auto" }}>
              <div className="w-full">
                ...
                <div className="w-full flex flex-col gap-3 mt-28 mb-10">
                      <ReactQuill
                        theme="snow"
                        modules={modules}
                        formats={formats}
                  ...
                  <div className="bg-[#fbb034] flex flex-wrap justify-start">
                    ...
                    <div className="w-full md:w-1/2 flex flex-col justify-center items-center">
                     {section_image2 ? (
                        ...
                        <img src={imageLiveUrl(state.sections[2].contents[0].data.section_2_image)} alt="Selected" />
                      )}
                      <input
                        type="file"
                        accept="image/*"
                ...
                <div className="h-auto w-full px-4 md:px-12 mt-8">
                  <div className="flex flex-wrap justify-center items-center gap-6 md:gap-0 md:mb-20 mb-8">
                    ...
                    {section_image3 ? (
                        ...
                        <img src={imageLiveUrl(state.sections[3].contents[0].data.section_3_image)} alt="Selected" />
                      )}
                      <input
                        type="file"
                        accept="image/*"
                    ...
                    <div className="w-full mt-10">
                      ...
                      <input
                        ...
                        className="px-4 py-1 sm:w-[20%] w-full"
                        placeholder={t("اكتب النص هنا")}
                        value={state.sections[3].contents[0].data_ar.button_text}
                      ...
                      <input
                        ...
                        className="px-4 py-1 sm:w-[20%] w-full"
                        placeholder={t("write button navigation")}
                        value={state.sections[3].contents[0].data.button_navigation}
                      ...
                      <input
                        ...
                        className="px-4 py-1 sm:w-[20%] w-full"
                        placeholder={t("اكتب التنقل هنا")}
                        value={state.sections[3].contents[0].data_ar.button_navigation}
...
export default UpdateTemplate3;
