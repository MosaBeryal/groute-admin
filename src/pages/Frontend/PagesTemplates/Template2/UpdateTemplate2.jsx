...
const UpdateTemplate2 = ({ isVisible, setVisibility, refreshTemplate2Data }) => {
                ...
                <div className="w-full py-8 mt-10">
                  <div className="bg-gray-100 flex flex-wrap justify-start">
                    ...
                    <input
                        ...
                        value={state.sections[1].contents[0].data.button_text}
                        onChange={(e) =>
                          handleChange(
                      ...
                      <input
                        ...
                        value={state.sections[1].contents[0].data_ar.button_text}
                        onChange={(e) =>
                          handleChange(
                      ...
                      <input
                        ...
                        value={state.sections[1].contents[0].data.button_navigation}
                        onChange={(e) =>
                          handleChange(
                      ...
                      <input
                        ...
                        value={state.sections[1].contents[0].data_ar.button_navigation}
                        onChange={(e) =>
                          handleChange(
