...
import AddTemplate2 from "./AddTemplate2";
import UpdateTemplate2 from "./UpdateTemplate2";
import ViewTemplate2PopUp from "./VeiwTemplate2PopUp";
...
const Template2 = () => {
  ...
  const {
    ...
    const refetchTemplate2Data = async () => {
      try {
    ...
    useEffect(() => {
      refetchTemplate2Data(); // Calling the function within useEffect, not inside itself
    }, []);
      ...
      >
            ...
            <div className="h-auto w-full p-0 bg-white shadow-xl rounded-md">
              ...
              >
                <button
                  ...
                  className="rounded-full bg-secondary font-body px-5 py-1 text-sm mb-3 text-white transition duration-200 hover:bg-primary bg-blue-900"
                >
        ...
        {isCreatePopupVisible && (
          <AddTemplate2
            ...
            refreshTemplate2Data={refetchTemplate2Data}
          />
        )}

        {isUpdatePopupVisible && (
          <UpdateTemplate2 isVisible={isUpdatePopupVisible} setVisibility={setUpdatePopupVisibility} refreshTemplate2Data={refetchTemplate2Data} />
        )}
        
        {isViewPopupVisible && (
          <ViewTemplate2PopUp isVisible={isViewPopupVisible} setVisibility={setViewPopupVisibility} slug={viewSlug}/>
        )}
      </div>
    </div>
  );
